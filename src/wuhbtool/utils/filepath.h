...
#define MAX_OSPATH 0x300 /* 0x100 BMP Unicode codepoints encoded as UTF-8 codeunits (max. 3 codeunits per codepoint) */
...
typedef struct filepath {
    char char_path[MAX_OSPATH];
    oschar_t os_path[MAX_OSPATH];
    validity_t valid;
} filepath_t;
